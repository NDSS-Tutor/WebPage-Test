...
async function renderSessionMessages(
    ...
    container.innerHTML = `
        ...
        <div
            id="session-message-list"
            class="session-message-list"
        >
        ...
        <form
            class="session-message-form"
            onsubmit="sendSessionMessage(event, '${sessionId}')"
        >
...
function initializeMessageRealtime(
    sessionId
) {
